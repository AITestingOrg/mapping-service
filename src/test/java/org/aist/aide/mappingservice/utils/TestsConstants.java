...
public class TestsConstants {
    ...
    public static final Classifier classifier = new Classifier(Services.APISERVICE.name(), 0.0);
    public static final Classifier classifierHighScore = new Classifier(Services.APISERVICE.name(), 0.9);
